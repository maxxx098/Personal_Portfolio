    ...
    <div>
      <section className='about section' id="about">
        ...
        <div className="about_container container grid">
          <img src={img4} alt="sy" className="about_img" />
          <div className='about_data'>
            <div className="about_info grid">
              <div className="about_box">
                <i className='bx bx-award about_icon'></i>
                <h3 className="about_title">Experience</h3>
                <span className="about_subtitle">2 Year's Working</span>
              </div>
              <div className="about_box">
            ...
            <button onClick={openModal} className="button button--flex">
              View CV
              <svg
            ...
            <Modal
              ...
              className="cv-modal"
              overlayClassName="cv-modal-overlay"
            >
              <div className="cv-modal-content">
                <iframe src={CV} title="My Resume" className="cv-iframe"></iframe>
                <button onClick={closeModal} className="cv-modal-close">
                  Close
                </button>
              </div>
            </Modal>
